...
```bash
├── /.devcontainer                            # Environment configuration files for different environments
├── /.envs                                    # Environment configuration files for different environments
├── /.git                                     # GitHub configuration files for commits, issues, and PR templates
├── /.github                                  # GitHub configuration files for commits, issues, and PR templates
├── /.vscode                                  # GitHub configuration files for commits, issues, and PR templates
...
├── /manuals                                  # Additional manuals and guides for the project
├── /policies                                 # Policy documents and guides for the project
...
├── Dockerfile                                # Dockerfile containing instructions for building the project image
